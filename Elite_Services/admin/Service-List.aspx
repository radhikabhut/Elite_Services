<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminSide.Master" AutoEventWireup="true" CodeBehind="Service-List.aspx.cs" Inherits="Elite_Services.admin.Service_List1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        ...
        <div class="frm box shadow1 ">
             Service:<asp:TextBox ID="txt_service" runat="server"></asp:TextBox>
            <br />
